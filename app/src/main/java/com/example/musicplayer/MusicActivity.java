...
public class MusicActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mGesture=(ImageView) findViewById(R.id.gesture);
        mBpmLibrary=(ImageView) findViewById(R.id.BpmLibrary);
    ...
    private void initEvent() {
        ...
        mBpmLibrary.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.next:
                ...
                break;
            case R.id.gesture:
                Intent BTconnect = new Intent(MusicActivity.this,BluetoothConnect.class);
                startActivity(BTconnect);
                break;
            case R.id.BpmLibrary:
                Intent BmpL = new Intent(MusicActivity.this,BpmLibrary.class);
                startActivity(BmpL);
                break;
        }
    }
